...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-white/10">
      <div className="absolute inset-0 bg-gradient-to-b from-white to-neutral-100"></div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-12">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
            ...
            <div className="lg:col-span-4">
              <div className="flex items-center space-x-4">
                <div className="avatar">
                  <div className="w-16 rounded-full ring-1 ring-white/10">
                    <img src="/5611.jpg" alt="logo" />
                  </div>
                </div>
                <div>
            ...
            <div className="grid grid-cols-2 gap-8 lg:col-span-8 lg:grid-cols-3">
              <div>
                <h3 className="text-sm font-light tracking-wider text-neutral-900">
                  {t("navbar.lang.title")}
                </h3>
          ...
          <div className="mt-12 border-t border-neutral-200 pt-8">
            <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
              ...
              <p className="text-sm leading-5 text-neutral-500">
                ...
                <a
                  href={`https://github.com/${t('footer.username')}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-primary transition-colors duration-300 font-medium ml-1"
                >
                  {t('footer.username')}
                </a>
              </p>
